...
| Rol | Modelo | Color |
|-----|--------|-------|
| planner | opencode-go/deepseek-v4.1-flash | warning (ámbar) |
| executor | opencode-go/deepseek-v4.1-flash | success (verde) |
| integrator | opencode-go/deepseek-v4.1-flash | accent (púrpura) |
| auditor | opencode-go/deepseek-v4.1-flash | error (rojo) |
