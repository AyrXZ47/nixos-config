...
- `modules/apps/` is split: home-side files imported by `home/default.nix` (shell, kitty, neovim, fastfetch, git, mpd, firefox, serena) vs system-side files imported by host configs (common-packages, flatpak, gaming).
