...
| 2026-08-15 | **nanoemoji YA está arreglado upstream**: el master de nixpkgs ahora pinna `sha256-FysyKC0...` (el hash que PyPI re-subió), idéntico al "got" del error. El fix del 08-13 era una ventana rota: PyPI re-subió el tarball, nixpkgs lo re-pinó después | El próximo `nix flake update nixpkgs` ya NO reintroduce el hash mismatch. La regla «no actualizar» del 14/08 queda obsoleta — actualizar es seguro de nuevo, con la salvedad del ISP lento/truncado |
